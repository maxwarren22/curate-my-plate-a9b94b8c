-- First, drop the foreign key constraint from shopping_lists
ALTER TABLE public.shopping_lists DROP CONSTRAINT IF EXISTS shopping_lists_meal_plan_id_fkey;
...
-- Now drop the old meal_plans table
